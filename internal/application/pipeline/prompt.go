...
func collectPromptLayers(ctx context.Context, agentSystem string, modelSystem string, meta *appsession.SessionMetadata, registar domtool.ToolsRegistar, logger hclog.Logger) promptLayers {
	layers := promptLayers{
		agent: agentSystem,
		model: modelSystem,
	}
...
func assembleSystemPrompt(p promptLayers, tmpl *infratemplate.Template, logger hclog.Logger) string {
