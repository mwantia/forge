...
//go:embed assets/app.css assets/htmx.min.js assets/htmx-ext-sse.js assets/alpine-persist.min.js assets/alpine.min.js assets/marked.min.js assets/mermaid.min.js assets/manifest.json assets/icon.svg assets/sw.js assets/resources.js
