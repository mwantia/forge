...
import (
	...
	"github.com/mwantia/forge/internal/infrastructure/server/api"
)
...
func init() {
	container.MustRegister[*ServerService](
		container.AsSingleton(),
		container.With[HttpRouter](),
	)
}

func (*ServerService) PreInit(context.Context) error {
	return nil
}
...
var _ approot.Service = (*ServerService)(nil)
